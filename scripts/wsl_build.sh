...
PACKAGES="jdamr_cube_bringup jdamr_cube_cartographer jdamr_cube_description jdamr_cube_gazebo jdamr_cube_moveit_config jdamr_cube_navigation jdamr_cube_node jdamr_cube_so101_arm jdamr_cube_teleop ldlidar_sl_ros2"
