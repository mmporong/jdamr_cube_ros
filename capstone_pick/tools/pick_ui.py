...
ARM_POSES = {
    # 홈 = 공식 rest 키프레임 그대로 (MuJoCo Menagerie SO-ARM100 [0,-3.32,3.11,1.18,0,-0.174],
    # home 키프레임 대응으로 오프셋 확정: lift+pi/2, elbow-pi/2, wrist 직접).
    # 실기(순정) 호환 우선 — 시뮬 전용 부품(손목캠·라이다)과는 근접하나 순정엔 없음.
    '홈': [0.0, -1.745, 1.54, 1.18, 0.0],
    '접힘': [0.0, -0.4, 1.0, 0.2, 0.0],     # 주행 자세 (pick_node와 동일)
    '상공': [0.0, 0.15, 0.2, 0.9, 0.0],
    '파지': [0.0, 0.48, 0.2, 0.9, 0.0],
    '바닥': [0.0, 1.15, 0.15, 0.28, 0.0],   # pick_node POSE_GRASP_FLOOR와 동일하게 유지할 것
}
